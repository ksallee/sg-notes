...
export const POST: RequestHandler = async ({ request }) => {
	...
	const appName = typeof fields.appName === 'string' && fields.appName ? fields.appName : 'sg-notes';
	const machineId = typeof fields.machineId === 'string' && fields.machineId ? fields.machineId : 'sg-notes';
