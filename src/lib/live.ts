...
const KEYS = {
	site: 'sg-notes:site',
	session: 'sg-notes:session',
	project: 'sg-notes:project'
} as const;
...
/** Settle the site and its auth. The header and the page both wait on this. */
...
/** The bare client, for writes: the cached one the widgets read through is what `create` reaches once it exists. */
