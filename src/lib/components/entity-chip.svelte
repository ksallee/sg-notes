...
<script lang="ts">
	...
	import { entityGlyph } from '$lib/components/entity-glyphs.js';
	import { CHIP_BOX, CHIP_CROSS, CHIP_GLYPH, CHIP_PAD, CHIP_SPACING, REMOVE_CONTROL } from '$lib/components/leaf-classes.js';
