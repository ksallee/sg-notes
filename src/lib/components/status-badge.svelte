<script lang="ts" module>
	import type { ChipSize } from '$lib/components/leaf-classes.js';
...
<script lang="ts">
	...
	import { CHIP_BOX, CHIP_CROSS, CHIP_GLYPH, CHIP_PAD, CHIP_SPACING, LEAF_GLYPH, REMOVE_CONTROL } from '$lib/components/leaf-classes.js';
