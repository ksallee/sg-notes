<script lang="ts" module>
	...
	import { CONTROL_GLYPH, CONTROL_HEIGHT, type ControlSize } from '$lib/components/control-classes.js';
...
<script lang="ts">
	...
	import SearchControl, { type SearchAnswer, type SearchRequest } from '$lib/components/search-control.svelte';
